...
form.addEventListener('submit', async e => {
  ...
  try {
    ...
    const paymentPanel = result.checkout_url
      ...
      : `<div class="alert error show">Your booking was saved in Sparkles Cleaning, but the Stripe deposit link could not be created yet. ${escapeHtml(result.checkout_error || 'Please contact Sparkles Cleaning to arrange payment.')}</div>`;
